...
void game_update(double delta_time) {
    ...
    Triangle test_triangle = draw_triangle(-1.5f, -1.5f, -1.5f, 0.0f, -0.5f, 0.0f, (Color){0.0f, 1.0f, 0.0f, 1.0f}, 1.0f, (Color){0.0f, 1.0f, 1.0f, 1.0f});
    Circle test_circle = draw_circle(-0.75f, 0.5f, 0.1f, (Color){0.0f, 0.5f, 1.0f, 1.0f}, 10, 2.0f, (Color){1.0f, 0.1f, 0.1f, 1.0f});
